...
- **Company accounts** (Clay, Monaco, Gong, …): add them under Settings → Searches → Tracked companies. Their posts count when they beat that account's usual likes (1.5× its median by default), instead of needing to go broadly viral.
